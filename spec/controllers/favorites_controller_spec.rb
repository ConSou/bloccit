...
RSpec.describe FavoritesController, type: :controller do
  let(:my_user) {User.create!(name: "Bloccit Bob", email: "bob@bob.com", password: "password")}
  ...
  context "signed in user" do
    ...
    describe "POST create" do
      ...
      it "creates favorite for user and specific post" do
    ...
    describe "DELETE destroy" do
      ...
      it "destroys the favorite for the post and user" do
